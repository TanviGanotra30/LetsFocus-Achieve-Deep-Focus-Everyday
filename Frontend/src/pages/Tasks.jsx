...
//             key={index}
//             whileHover={{ y: -3 }}
//             className="rounded-3xl border border-white/10 bg-black/20 p-5 cursor-pointer"
//           >
...
//           <div>
//             <h2 className="text-5xl font-black">Tasks</h2>
