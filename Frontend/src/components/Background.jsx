...
//       {/* Blob 1 */}
//       <motion.div
//         className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full blur-3xl opacity-30 bg-indigo-500"
//         animate={{
//           x: [0, 60, 0],
//           y: [0, 40, 0],
//         }}
...
//       {/* Blob 2 */}
//       <motion.div
//         className="absolute top-1/3 -right-32 w-[600px] h-[600px] rounded-full blur-3xl opacity-25 bg-cyan-500"
//         animate={{
//           x: [0, -60, 0],
//           y: [0, -40, 0],
//         }}
...
//       {/* Blob 3 */}
//       <motion.div
//         className="absolute bottom-0 left-1/3 w-[500px] h-[500px] rounded-full blur-3xl opacity-25 bg-purple-500"
//         animate={{
//           x: [0, 40, 0],
//           y: [0, -60, 0],
//         }}
